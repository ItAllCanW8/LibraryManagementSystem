<%@ Page Title="" Language="C#" MasterPageFile="~/librarian/librarian.Master" AutoEventWireup="true" CodeBehind="send_message.aspx.cs" Inherits="LibraryManagementSystem.librarian.send_message1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="c1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function send_message() {
            ...
            xmlhttp.open("GET", "send_from_librarian.aspx?username=" + username + "&msg=" + document.getElementById("t1").value, true);
            xmlhttp.send();
