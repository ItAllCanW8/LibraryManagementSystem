<%@ Page Title="" Language="C#" MasterPageFile="~/librarian/librarian.Master" AutoEventWireup="true" CodeBehind="communication.aspx.cs" Inherits="LibraryManagementSystem.librarian.send_message" %>
        ...
        <asp:Repeater ID="r1" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td><%#Eval("contact") %></td>
                    <td><%#Eval("approved") %></td>
                    <td><a href="send_message.aspx?username=<%#Eval("username") %>">Send Message</a></td>
                </tr>
            </ItemTemplate>
