<%@ Page Title="" Language="C#" MasterPageFile="~/student/student.Master" AutoEventWireup="true" CodeBehind="communication.aspx.cs" Inherits="LibraryManagementSystem.student.communication" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="c1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function send_message() {
            ...
            xmlhttp.open("GET", "send_from_student.aspx?msg=" + document.getElementById("t1").value, true);
            xmlhttp.send();
