...
<body class="bg-dark">
                ...
                <div class="login-form">
                    <form id="form1" runat="server">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="enrollmentNum" runat="server" class="form-control" placeholder="Enrollment Number"></asp:TextBox>
                        </div>
    ...
    <script type="text/javascript">
        var your_site_key = '6Lc4yMAaAAAAAFR4-MN-RYbLe3GrzjgSlaqIcQ1U';
        var renderRecaptcha = function () {
            grecaptcha.render('ReCaptchContainer', {
                'sitekey': '6Lc4yMAaAAAAAFR4-MN-RYbLe3GrzjgSlaqIcQ1U',
