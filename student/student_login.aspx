<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="student_login.aspx.cs" Inherits="LibraryManagementSystem.student.student_login" %>
            ...
            <div class="login-content">
                ...
                <div class="login-form">
                    <form id="f1" runat="server">
                        ...
                        <asp:Button ID="b2" runat="server" Text="Sign Up" class="btn btn-primary btn-flat m-b-30 m-t-30" OnClick="b2_Click"></asp:Button><br />
